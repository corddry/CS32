...
int main(int argc, char *argv[])
{
	...
	//GeoCoord izza("34.0724746", "-118.4923463");
	//vector <StreetSegment> issa;
	//sm.getSegmentsThatStartWith(izza, issa);
	//for(int i = 0; i < issa.size(); i++)
	//	cout << issa[i].start.latitudeText << ", " << issa[i].start.longitudeText << ", " << issa[i].end.latitudeText << ", " << issa[i].end.longitudeText << ", " << " Name: " << issa[i].name << endl;
